    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            ...
            <div class="btn-group" role="group">
                <a href="{{ route('admin.educators.courses', $educator->id) }}"
                    class="btn btn-outline-primary">Courses</a>
                <a href="{{ route('admin.educators.payouts', $educator->id) }}"
                    class="btn btn-outline-primary">Payouts</a>
                <a href="{{ route('admin.educators.earnings', $educator->id) }}"
                    class="btn btn-outline-primary">Earnings</a>
                <a href="{{ route('admin.educators.sessions', $educator->id) }}"
                ...
                <div class="p-4">
                    <div class="d-flex align-items-start gap-3 mb-4">
                        @if ($educator->profile_picture_url)
                            <img src="{{ $educator->profile_picture_url }}" alt="avatar" class="rounded-circle"
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            {{ $educator->last_login_at ? $educator->last_login_at->format('M d, Y H:i') : 'Never' }}
                        </div>
                    </div>
                    ...
                    @if ($profile)
                        ...
                        <div class="border-top pt-4 mb-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="mt-1">
                                        {{ $profile->hourly_rate ? '$ ' . number_format($profile->hourly_rate, 0) : 'N/A' }}
                                    </p>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="mt-1">
                                        @php
                                            $levels = $profile->teaching_levels
                                                ? json_decode($profile->teaching_levels, true)
                                                : null;
                                        @endphp
                        ...
                        <div class="border-top pt-4 mb-4">
                            ...
                            <div class="row g-3">
                                    ...
                                    <div class="border rounded p-3 text-center h-100">
                                        ...
                                        @if ($profile->cv_path)
                                            ...
                                            @if (in_array($cvExt, ['jpeg', 'jpg', 'png']))
                                                <img src="{{ asset($profile->cv_path) }}" alt="CV"
                                            ...
                                            @endif
                                            <a href="{{ asset($profile->cv_path) }}" target="_blank"
                                    ...
                                    <div class="border rounded p-3 text-center h-100">
                                        ...
                                        @if ($profile->degree_proof_path)
                                            ...
                                            @if (in_array($degreeExt, ['jpeg', 'jpg', 'png']))
                                                <img src="{{ asset($profile->degree_proof_path) }}" alt="Degree"
                                                    class="img-fluid rounded mb-2"
                                                    style="max-height: 200px; object-fit: contain;">
                                            @else
                                                <div class="bg-light rounded d-flex align-items-center justify-content-center mb-2"
                                            ...
                                            @endif
                                            <a href="{{ asset($profile->degree_proof_path) }}" target="_blank"
                                                class="btn btn-sm btn-outline-primary w-100">
                                    ...
                                    <div class="border rounded p-3 text-center h-100">
                                        ...
                                        @if ($profile->intro_video_path)
                                            <video class="w-100 rounded mb-2" style="max-height: 200px;" controls>
                                                <source src="{{ asset($profile->intro_video_path) }}"
                                                    type="video/mp4">
                                                Your browser does not support the video tag.
                                            </video>
                                            <a href="{{ asset($profile->intro_video_path) }}" target="_blank"
                                                class="btn btn-sm btn-outline-primary w-100">
                                ...
                                <div class="col-md-12">
                                    <div class="border rounded p-3 text-center h-100">
                                        <h6 class="mb-2"><i class="bi bi-file-earmark me-1"></i>Additional Documents
                                        </h6>
                                        <div class="row">
                                            @forelse ($educator->additionalDocuments as $document)
                                                @php
                                                    ...
                                                    $icon = $fileIcons[$ext] ?? 'fa-file text-secondary';
                                            ...
                                            @empty
                                                <div class="col-12">
                                                    <span class="badge bg-secondary">No Documents Uploaded</span>
                                                </div>
                                            @endforelse
                                        </div>
                                    </div>
                                        ...
                                        <div class="card h-100">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <span
                                                        class="badge text-bg-{{ $course->status === 'published' ? 'success' : 'warning' }}">
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            <div class="text-center">
                                <div class="kpi-value">{{ $educator->courses ? $educator->courses->count() : 0 }}
                                </div>
                        ...
                        <div class="col-6">
                            <div class="text-center">
                                <div class="kpi-value">
                                    {{ $educator->courses ? $educator->courses->where('status', 'published')->count() : 0 }}
                                </div>
                    ...
                    <form method="POST" action="{{ route('admin.educators.sendNote', $educator->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="subject" value="{{ old('subject') }}"
                                ...
                                placeholder="e.g. Profile Update Required" required>
                            @error('subject')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="body" rows="5" class="form-control @error('body') is-invalid @enderror"
                                placeholder="Write your note here..." required>{{ old('body') }}</textarea>
                            @error('body')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
