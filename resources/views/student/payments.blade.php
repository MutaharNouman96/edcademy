...
@section('content')
  {{-- All content for this page goes here, without a <main> tag or column definitions --}}
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        <div class="border rounded p-3 h-100">
          ...
          <button class="btn btn-sm btn-outline-primary"><i class="bi bi-link-45deg me-1"></i> Connect PayPal</button>
        </div>
      </div>
      <div class="col-md-12">
        <div class="border rounded p-3">
          ...
          <button class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil me-1"></i> Edit Billing Info</button>
        </div>
      </div>
    </div>
  </div>
