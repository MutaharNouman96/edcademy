                    ...
                    <div class="col-md-4">
                      <div class="form-section">
                        <div class="d-flex flex-column align-items-center text-center">
                          <img id="avatarPreview" src="https://www.teachhub.com/wp-content/uploads/2021/09/Aug-30-Challenges-Faced-by-a-First-Generation-College-Student_web-768x519.jpg" alt="avatar" class="avatar-preview mb-2 img-fluid d-block mx-auto">
                          <div class="mb-2">
                    ...
                    <div class="col-md-8">
                      <div class="form-section">
                        <div class="mb-3 row">
                          ...
                          <div class="col-sm-9"><input id="fullName" class="form-control" value="{{ old('first_name', $user->first_name) }}"></div>
                        </div>

                        <div class="mb-3 row">
                          <label class="col-sm-3 col-form-label">Last name</label>
                          <div class="col-sm-9"><input id="displayName" class="form-control" value="{{ old('last_name', $user->last_name) }}"></div>
                        </div>
