                ...
                <div class="row mb-5">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            <img src="{{ $educator->profile_picture ?? 'https://placehold.co/40x40/E55A2B/white?text=E' }}"
                                                class="rounded-circle me-2" alt="Profile Picture" width="40"
                                                height="40">
                                            <div>
                                                <h6 class="mb-0">
                                                    {{ $educator->first_name . ' ' . $educator->last_name ?? 'Unknown Uploader' }}
                                                </h6>
                                                <small class="text-muted">Uploaded on
                                                    {{ $course->created_at->format('M d, Y') }}</small>
                                            </div>
                                            <hr />
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <div>
                                                <span class="badge bg-secondary">Lesson
                                                    {{ $currentLesson->lesson_number }} of
                                                    {{ $course_lessons->where('course_section_id', $currentLesson->course_section_id)->count() }}</span>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="list-group">
                                            @php
                                                ...
                                                $currentIndex = $allLessonsSorted->search(function ($lesson) use (
                                                    $currentLesson,
                                                ) {
                                    ...
                                    <div class="p-2">
                                        <div class="mt-4">
                                            <form id="comment-form"
                                                action="{{ route('student.lesson_comment.store') }}">
                                                @csrf
                                            ...
                                            <div id="comments-list" class="mt-3">
                                                @foreach ($comments as $comment)
                                                    <div class="d-flex align-items-start mb-3">
                                                        <img src="{{ $comment->user->profile_picture ?? 'https://placehold.co/40x40/E55A2B/white?text=U' }}"
                    ...
                    @else
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="fw-bold mb-3">No lesson found</h4>
                                </div>
                            </div>
                        </div>
                    @endif
